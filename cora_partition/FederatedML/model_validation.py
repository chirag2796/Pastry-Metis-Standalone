...
if __name__=="__main__":
    ...
    # # gnn_model.load_weights("/home/chirag/fl/keras-gnn/cora_partition/FederatedML/Received_Models/new_model_<0x9F8BDA..>_0.h5")
    # gnn_model.load_weights("/home/chirag/fl/keras-gnn/cora_partition/FederatedML/new_model_<0x39607A..>_0.h5")
    # evaluate(gnn_model, data_origin="SAVED")
    path = "/home/chirag/fl/keras-gnn/cora_partition/FederatedML"


    new_model_loaded = get_model_structure_by_path(path + "/saved_structure")
    new_model_loaded.load_weights("/home/chirag/fl/keras-gnn/cora_partition/FederatedML/new_model_<0xFCE0E5..>_1.h5")
