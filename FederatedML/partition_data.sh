...
# python /home/chirag/fl/keras-gnn/cora_partition_metis/FederatedML/partition_data.py $1 $2 $3 $4
python /home/chirag/fl/keras-gnn/cora_partition_metis/FederatedML/partition_data.py "$*"