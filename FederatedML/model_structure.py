...
def get_model_structure():
    ...
    with open(path+"/edges.pickle", 'wb') as handle:
        pickle.dump(edges, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
    with open(path+"/edge_weights.pickle", 'wb') as handle:
        pickle.dump(edge_weights, handle, protocol=pickle.HIGHEST_PROTOCOL)

    with open(path+"/node_features.pickle", 'wb') as handle:
        pickle.dump(node_features, handle, protocol=pickle.HIGHEST_PROTOCOL)

    with open(path+"/num_classes.pickle", 'wb') as handle:
    ...
    # gnn_model.load_weights(path+"/Received_Models/model_1.h5")
    return gnn_model
...
if __name__=="__main__":
    path = "/home/chirag/fl/keras-gnn/cora_partition_metis/FederatedML/saved_structure/model_structure"
